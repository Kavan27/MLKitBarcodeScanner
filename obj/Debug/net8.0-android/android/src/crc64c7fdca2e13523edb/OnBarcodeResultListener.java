...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("MLKitBarcodeScannerApp.Platforms.Android.OnBarcodeResultListener, MLKitBarcodeScannerApp", OnBarcodeResultListener.class, __md_methods);
	}
	...
	public OnBarcodeResultListener ()
	{
		...
		if (getClass () == OnBarcodeResultListener.class) {
			mono.android.TypeManager.Activate ("MLKitBarcodeScannerApp.Platforms.Android.OnBarcodeResultListener, MLKitBarcodeScannerApp", "", this, new java.lang.Object[] {  });
		}
	}
